...
describe( 'async', function tests() {
	...
	it( 'should create a Makefile in a specified directory', function test() {
		var dirpath;
	...
	it( 'should create a Makefile in a specified directory without requiring a callback', function test() {
		var dirpath;
	...
	it( 'should create a Makefile using a specified template', function test() {
		var dirpath;
