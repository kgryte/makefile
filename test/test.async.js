...
describe( 'async', function tests() {
	...
	it( 'should create a Makefile in a specified directory', function test( done ) {
		var dirpath;
		...
		function onFinish( error ) {
			...
			if ( error ) {
				...
				bool = fs.existsSync( path.join( dirpath, 'Makefile' ) );
	...
	it( 'should create a Makefile in a specified directory without requiring a callback', function test( done ) {
		var dirpath;
		...
		function onTimeout() {
			var bool = fs.existsSync( path.join( dirpath, 'Makefile' ) );
	...
	it( 'should create a Makefile using a specified template', function test( done ) {
		var dirpath;
		...
		function onFinish( error ) {
			...
			fpath1 = path.join( dirpath, 'Makefile' );
